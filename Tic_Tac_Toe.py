#fuction for Displaying the board
...
#function for checking Winning Status
...
#chooseing which player goes first
import random
...
#checking if the choosed position is empty or not
...
#checking if wants to play again or not 
def replay():
